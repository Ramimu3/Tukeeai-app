        ...
        {#each BlogDatadata as item}
            <div class="blog relative rounded-md shadow shadow-slate-200 dark:shadow-gray-800 overflow-hidden">
                ...
                <div class="content p-6">
                    ...
                    <div class="mt-5">
                        <a href="/blogs" class="hover:text-violet-600 dark:hover:text-violet-600 after:bg-violet-600 dark:text-white transition duration-500">{item.more}<i class="uil uil-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        {/each}
